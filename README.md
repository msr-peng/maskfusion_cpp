...
# 1. How to build it? #
The system has been developed for Linux. It has been tested on Ubuntu 16.04, with gcc-5, CUDA 9.2, OpenGL 4.5.0 (NVIDIA Driver 384.90), and CMake 3.8.2, with an Intel Core i7-5820K CPU @ 3.30GHz and 2 Nvidia Geforce GTX 1080i.
...
# 4. License #
MaskFuion_cpp is freely available for non-commercial use only.
